...
namespace Slutty_Darius
{
    internal class Program
    {
        ...
        public static Orbwalker_OnAction Orbwalker;
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            OrbwalkerType.BeforeAttack += BeforeAttack;


        }
        private static void OnInterruptableSpell(AIHeroClient unit, Interrupter.InterruptSpellArgs spell)
        {
